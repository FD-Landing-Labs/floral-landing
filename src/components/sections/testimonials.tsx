...
function TestimonialCard({
  ...
  return (
    <motion.div
      ...
      className="bg-white rounded-2xl p-5 md:p-6 shadow-sm border border-border/50"
    >
      ...
      <div className="container px-6 md:px-12 lg:px-16">
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-6">
            {/* Left laurel/bracket */}
            <svg
              className="w-6 h-12 text-foreground/20"
              viewBox="0 0 24 48"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
                d="M20 4C12 8 6 16 6 24C6 32 12 40 20 44"
                stroke="currentColor"
                strokeWidth="2"
                strokeLinecap="round"
              />
            ...
            <span className="text-[clamp(3rem,8vw,5rem)] font-medium text-foreground tracking-tight">
              {data.overallRating}
            </span>

            {/* Right laurel/bracket */}
            <svg
              className="w-6 h-12 text-foreground/20"
              viewBox="0 0 24 48"
              fill="none"
            ...
            >
              <path
                d="M4 4C12 8 18 16 18 24C18 32 12 40 4 44"
                stroke="currentColor"
                strokeWidth="2"
                strokeLinecap="round"
              />
          ...
          {/* Headline */}
          <h2 className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-md mb-10">
            ...
            {data.ratingCategories.map((category, index) => (
              <motion.div
                ...
                className={`text-center px-4 ${
                  index !== data.ratingCategories.length - 1
                    ? "border-r border-border"
                    : ""
                }`}
              >
                <p className="text-2xl md:text-3xl font-medium text-foreground mb-1">
                  {category.value}
                </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5 mb-12">
          ...
          {/* Center Column */}
          <div className="flex flex-col gap-4 md:gap-5 md:pt-6">
          ...
          {/* Right Column */}
          <div className="flex flex-col gap-4 md:gap-5 md:pt-3">
